...
## [2.2.0](https://github.com/wus-technik/mcp-freescout/compare/v2.1.1...v2.2.0) (2026-09-02)
...
* add freescout_get_timelogs tool for viewing logged time ([95b8e4f](https://github.com/wus-technik/mcp-freescout/commit/95b8e4feeb4a13b2739549483e260df37289ff48))
* add freescout_log_time tool for booking time on a ticket ([86b7206](https://github.com/wus-technik/mcp-freescout/commit/86b7206016a82b5b8fbb123af56c89cb42f1ed03))
* add freescout_send_reply tool for sending real replies ([acd9be0](https://github.com/wus-technik/mcp-freescout/commit/acd9be0c0b61a5c03a285a5544ee584faa0feb31))
* add freescout_whoami tool for resolving the current API user ([94516db](https://github.com/wus-technik/mcp-freescout/commit/94516db408fb8d606b7e1980998ec56a8f780904))
...
* resolve acting user via /users/me in hosted mode ([c3945df](https://github.com/wus-technik/mcp-freescout/commit/c3945df23485da845e0f6da5bfae4cc7717c874c))
